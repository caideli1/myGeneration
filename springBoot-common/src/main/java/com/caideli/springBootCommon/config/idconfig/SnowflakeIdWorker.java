package com.caideli.springBootCommon.config.idconfig;
...
public class SnowflakeIdWorker {
    ...
    public SnowflakeIdWorker(long workerId, long dataCenterId) {
        ...
        this.workerId = getWorkerId(dataCenterId, workerId);
        this.dataCenterId = getDataCenterId(dataCenterId);
    }
    ...
    private long getDataCenterId(long maxDataCenterId) {
        ...
        try {
            ...
            log.error(" getDataCenterId error: {}", e.getMessage());
        }
        return id;
    }
}