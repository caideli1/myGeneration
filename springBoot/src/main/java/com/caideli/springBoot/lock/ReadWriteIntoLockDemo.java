 ...
 * @Date : 2020/9/28 0028 14:46
 * 描述：
 */
public class ReadWriteIntoLockDemo {
    ...
    public Object handleRead(Lock lock) throws InterruptedException{
        ...
        try {
            System.out.printf("读重入锁锁前："+Thread.currentThread().getName()+"\n");
            lock.lock();
    ...
    public void handleWrite(Lock lock,int value) throws InterruptedException{
        try {
            System.out.printf("------写重入锁锁前："+Thread.currentThread().getName()+"\n");
            lock.lock();
    ...
    public static void main(String[] args) throws InterruptedException {
        final ReadWriteIntoLockDemo demo=new ReadWriteIntoLockDemo();
